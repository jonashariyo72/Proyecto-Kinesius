        ...
        {clases.map(c => (
          <div key={c.id} style={{ ...s.card, opacity: c.activa ? 1 : 0.5 }}>
            ...
            <div style={s.cardMid}>
              <span style={s.dia}>
                {c.fecha_clase
                  ? new Date(c.fecha_clase + 'T00:00:00').toLocaleDateString('es-AR', {
            ...
            <form onSubmit={guardar} style={s.formGrid}>
              ...
              <div style={s.campo}>
                ...
                <input
                  ...
                  onInvalid={e => e.target.setCustomValidity(`La capacidad debe ser mayor o igual a ${capacidadOriginal}`)}
                  required
                />
              </div>
              ...
              <div style={s.campo}>
                ...
                <input
                  ...
                  type="number" value={15000} readOnly
                />
              </div>
              ...
              <div style={{ ...s.acciones, gridColumn: '1 / -1', marginTop: 4 }}>
                <button type="button" style={s.btnCancelar} onClick={() => setModal(false)}>
                  Cancelar
                </button>
                <button
                  type="submit"
          ...
          <div style={s.modal}>
            ...
            <div style={s.avisoRojo}>
              <p style={{ margin: 0, fontSize: 13, lineHeight: 1.5 }}>
                ⚠️ Se cancelarán todas las reservas activas y se procesarán
            ...
            <div style={{ display: 'flex', gap: 10, marginTop: 16 }}>
              ...
              <button style={s.btnEliminarConfirm} onClick={desactivar}>
                Sí, eliminar
              </button>
            </div>
          </div>
...
const s = {
  ...
  border: '1px solid #c8a000', background: 'transparent',
  color: '#c8a000', fontSize: 13, cursor: 'pointer',
},
  toast: {
